...
const Newsletter = () => (
  <div className="app__newsletter" id="ourstory">
    <div className="app__newsletter-heading">
      <SubHeading title="Our Story" />
      <div className="story-div">
        <h1 className="headtext__cormorant">Two years ago,</h1>

        <p className="p__opensans">
          <span className="story-name">Dia Sawan</span> started toying with the notion of a club like no other he’d ever seen.
        </p>
        <p className="p__opensans">
        ...
        <p className="p__opensans">Why not try to strike lightning twice?!</p>
        <p className="p__opensans">
        ...
        <p className="p__opensans">
          ...
          the U.K. “There’s not another one of these in the world,” says Sawan of the firework optics whose glow explodes beautifully from
          atop polished granite floors.
        </p>
        <p className="p__opensans">
        ...
        <p className="p__opensans">
          ...
          Steak with Scallion to Braised Short Ribs with Wasabi Mashed Potatoes all appetites will be appeased. Washing them down with
          Vango’s specialty cocktails - variations on familiar themes like the Vango Bellini and the Vangohattan - should help.
        </p>
        <p className="p__opensans">
          All this leaves is the dance floor and Vango’s nightly lineup of the very best DJs that this town has to offer. From drinks to
